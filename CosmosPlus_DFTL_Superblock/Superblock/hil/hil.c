...
void HIL_DatasetManagement(unsigned int nCmdSlotTag, unsigned int nr, unsigned int ad)
{
//	xil_printf("DSM Num of Range: %u, DISCARD(%u)\r\n", nr, ad);
	FTL_DatasetManagement(nCmdSlotTag, nr, ad);
}
