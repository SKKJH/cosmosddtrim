...
public:
	...
	BOOL Write(VOID* pstRequest, IOTYPE eRequestType, IOTYPE GC_TYPE);
...
private:
	VOID			_IssueProgram(IOTYPE GC_TYPE);
...
public:
	...
	UINT32 ReadLPN(UINT32 nLPN, BUFFER_ENTRY* pstBufferEntry, UINT32 channel, UINT32 way);
