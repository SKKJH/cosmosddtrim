...
//    XTime_GetTime(&t3);  // Phase2 끝
//
//    // ===== 시간 변환 및 출력(마지막에) =====
//    dt_phase1 = (u64)(t1 - t0);
//    dt_phase2 = (u64)(t3 - t2);
//
//    us_p1 = (u32)(dt_phase1 / TICKS_PER_US);
//    ns_p1 = (u32)(dt_phase1 * NS_PER_TICK);
//    us_p2 = (u32)(dt_phase2 / TICKS_PER_US);
//    ns_p2 = (u32)(dt_phase2 * NS_PER_TICK);
//
//    if (DFTL_GLOBAL::GetInstance()->print_cnt <= 10)
//    {
//    	xil_printf("[TIME][FindTopKTrimSegments] Phase1-Select: %u us (%u ns)\r\n", us_p1, ns_p1);
//    	xil_printf("[TIME][FindTopKTrimSegments] Phase2-Load  : %u us (%u ns)\r\n", us_p2, ns_p2);
//    	xil_printf("[TIME][FindTopKTrimSegments] Total        : %u us\r\n", (u32)(us_p1 + us_p2));
//        UINT32 discard_loaded = DFTL_GetProfile(Prof_Discard_Load_Page);
//        xil_printf("[PROF][GC] Prof_Discard_Load_Page (this GC): %u\r\n", discard_loaded);
//    	DFTL_ResetProfile(Prof_Discard_Load_Page);
//    }
    return Load_CNT;
}
