...
//
//      pstHILRequestInfo->RemoveFromIssuedQ(m_parent_req);
//      xil_printf("ADDR_PRINT_PROFILE RemoveFromIssuedQ\r\n");
//      pstRequestMgr->GetHILRequestInfo()->ReleaseRequest(m_parent_req);
//      xil_printf("ADDR_PRINT_PROFILE ReleaseRequest\r\n");
//
//      //per way
//      pstHILRequestInfo->RemoveFromWaitQ_per_way(this, m_channel, m_way);
//      xil_printf("ADDR_PRINT_PROFILE RemoveFromWaitQ_per_way\r\n");
//
//      pstHILRequestInfo->ReleaseRequest_per_way(this);
//      xil_printf("ADDR_PRINT_PROFILE ReleaseRequest_per_way\r\n");
//
//      return TRUE;
//   }
    ...
    if (DFTL_GLOBAL::GetInstance()->m_bDSMEnable > 1)
    {
    	for (UINT32 i = 0; i < m_nLPNCount; i++)
    	{
    		...
    		for (UINT32 j = 0; j < nLength; ++j, ++nCurLPN)
    		{
    			...
    			DFTL_IncreaseProfile(Prof_Discard_Total_Page);
    		}
