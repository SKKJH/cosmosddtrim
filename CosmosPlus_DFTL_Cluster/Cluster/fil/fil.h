...
#define MAX_CHANNEL_BITS					(3)
#define MAX_WAY_BITS					(3)
...
#define NUM_BIT_VPAGE				(NUM_BIT_LPN_PER_PAGE + NUM_BIT_PPAGE)
#define NUM_BIT_PAGE_PER_WAY		(NUM_BIT_VPAGE + NUM_BIT_BLOCK)
#define NUM_BIT_PAGE_PER_CHANNEL	(NUM_BIT_PAGE_PER_WAY + MAX_WAY_BITS)


// Refer to ftl_config.h to get layout
#define NAND_ADDR_PPAGE_SHIFT		(NUM_BIT_LPN_PER_PAGE)
#define NAND_ADDR_BLOCK_SHIFT		(NUM_BIT_VPAGE)
#define NAND_ADDR_VBN_SHIFT			(NAND_ADDR_BLOCK_SHIFT)
#define NAND_ADDR_WAY_SHIFT			(NUM_BIT_VPAGE + NUM_BIT_BLOCK)
#define NAND_ADDR_CHANNEL_SHIFT		(NUM_BIT_VPAGE + NUM_BIT_BLOCK + MAX_WAY_BITS)
...
#define NAND_ADDR_PAGE_PER_WAY		((1 << NAND_ADDR_WAY_SHIFT) - 1)
...
typedef struct
{
	unsigned int nCh		: MAX_CHANNEL_BITS;					// LSB position, bit 0
	unsigned int nWay		: MAX_WAY_BITS;
