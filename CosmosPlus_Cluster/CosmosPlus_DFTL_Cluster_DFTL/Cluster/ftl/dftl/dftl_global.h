...
public:
	...
	INT32 m_trim_pages[USER_CLUSTERS];
	...
	void UpdateTrimStat(UINT32 pages, UINT32 loads, UINT32 hits, UINT32 t_dma, UINT32 t_cmt, UINT32 t_wb, UINT32 t_l2v);
	void PrintTrimStat(void);
