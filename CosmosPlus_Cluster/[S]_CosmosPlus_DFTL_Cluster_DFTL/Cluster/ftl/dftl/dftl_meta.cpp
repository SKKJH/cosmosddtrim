...
BOOL
META_CACHE::IsMetaAvailable(UINT32 nLPN, UINT32 bIsMETA)
{
#if (META_PER_WAY==1)
...
BOOL
META_CACHE::IsMetaWritable(UINT32 nLPN, UINT32 bIsMETA)
{
#if (META_PER_WAY==1)
	UINT32 mod_lpn = get_mod_lpn(nLPN);
#else
...
VOID
META_CACHE::LoadMeta(UINT32 nLPN, UINT32 DS_FLAG, UINT32 bIsMETA)
{
#if (META_PER_WAY==1)
	UINT32 mod_lpn = get_mod_lpn(nLPN);
#else
