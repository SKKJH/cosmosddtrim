...
public:
	PROGRAM_UNIT(VOID);
	VOID Add(UINT32 cID, VOID* pstRequest, UINT32 nVPPN, IOTYPE eBlockType, IOTYPE eRequestType);
	...
	UINT32 GetCID(VOID) {return m_nCID;}
	VOID InvalidateLPN(INT32 nIndex) { m_anLPN[nIndex] = INVALID_LPN; }
...
private:
	VOID			_IssueProgram(UINT32 cID, IOTYPE GC_TYPE);
...
public:
	...
	UINT32 ReadLPN(UINT32 nLPN, BUFFER_ENTRY* pstBufferEntry, UINT32 cID, UINT32 channel, UINT32 way);
...
{
public:
	VOID Initialize(UINT32 cluster, UINT32 channel, UINT32 way);
