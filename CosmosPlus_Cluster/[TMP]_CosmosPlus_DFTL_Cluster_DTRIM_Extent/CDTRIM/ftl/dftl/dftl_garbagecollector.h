...
// [Added] Threshold for triggering TRIM processing (1GB in 4KB pages)
// 1GB = 1024*1024*1024 bytes, Page = 4096 bytes -> 262144 pages
#define TRIM_FLUSH_THRESHOLD (16384)*2
...
public:
	...
	UINT32 	ProcessAllPendingTrim(VOID);

	UINT32 	ProcessSelectiveTRIM(VOID);
	...
	INT32	m_nTMPVictimVBN = INVALID_VBN;			// Victim block
