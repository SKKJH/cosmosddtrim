...
#define META_REQUEST_COUNT			(USER_CHANNELS * USER_WAYS)
...
public:
	...
	VOID	Initialize(META_REQUEST_STATUS nStatus, UINT32 m_nMetaLPN, VOID* pstMetaEntry, IOTYPE eIOType, UINT32 bMetaFlag);
	BOOL	Run(VOID);
