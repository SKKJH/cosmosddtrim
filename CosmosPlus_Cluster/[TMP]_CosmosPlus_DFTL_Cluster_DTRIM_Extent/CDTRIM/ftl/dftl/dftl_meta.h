...
public:
	...
	VOID				LoadMeta(UINT32 nLPN, UINT32 DS_FLAG, BOOL bMetaFlag);
...
public:
	...
	VOID 	ApplyTrimOnLoadedEntry_OPT(META_CACHE_ENTRY* pstMetaEntry, UINT32 metaLPN, UINT32 FLAG);
	...
	META_CACHE_ENTRY* GetMetaEntry(UINT32 nLPN, UINT32 IsMETA);
