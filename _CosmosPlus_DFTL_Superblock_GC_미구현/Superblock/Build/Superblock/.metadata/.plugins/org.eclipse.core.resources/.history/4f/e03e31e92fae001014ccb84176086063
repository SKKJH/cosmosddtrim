...
public:
    ...
    VOID DebugPrintAllByVBN() const;
    VOID DebugPrintAllByVBN_CW(UINT32 channel, UINT32 way) const;

	VOID	Initialize(BLOCK_MGR_TYPE eType);
	VOID	Format(VOID);
	UINT32	Allocate(UINT32 channel, UINT32 way, BOOL bUser, BOOL bGC, BOOL bMeta);				// get a free Virtual Block
	VOID	Release(UINT32 channel, UINT32 way, UINT32 nVBN);
